...
public class GetContentHighlightServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(req.getParameter("libId") == null){
			...
			Collection<Highlight> highlights  = dao.ofy().query(Highlight.class).filter("section",sectionKey).filter("type","main").filter("user !=", userK).list();
