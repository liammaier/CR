<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/basic/library/allbooks.css" />
		...
		<script src="/basic/library/allbooks.js"></script>
	...
	<body>
		...
		<div id="titleResourcesBar">
			<center>
				...
				<h1 class="title inline">My Books</h1>
			</center>
			<hr>
			<div id="resourcesSection">
				<p>You have no book in your library. Please contact <a href="mailto:fickas@cs.uoregon.edu">fickas@cs.uoregon.edu</a> to populate your library.</p>
			</div>
		</div>
		<hr>
