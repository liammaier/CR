<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/basic/library/managelibrary.css" />
		...
		<script src="/basic/library/managelibrary.js"></script>
		<script src="/basic/library/calendar.js"></script>
